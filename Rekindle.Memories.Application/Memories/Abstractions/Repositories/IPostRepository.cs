...
public interface IPostRepository
{
    ...
    Task<IEnumerable<Post>> FindByMemoryIdWithPagination(Guid memoryId, int limit, DateTime? cursor = null, CancellationToken cancellationToken = default);
    ...
    Task<CursorPaginationResponse<Post>> FindByMemoryIdWithPaginationAsync(Guid memoryId, int pageSize = 20, DateTime? cursor = null);
}
